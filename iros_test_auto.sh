...
#ros2 run benchbot_xarm6_cpp benchbot_xarm6_cpp -- --light-temp 6500,0.3,1 --both --closest --bench-sample-gap 1 --arm_random_locations 0 --arm-sample-gap 11 --pred "0,0,10" --pcg-seed-incr 0
#ros2 run benchbot_xarm6_cpp benchbot_xarm6_cpp -- --light-temp 6500,0.3,1 --both --closest --bench-sample-gap 1 --arm_random_locations 0 --arm-sample-gap 4 --pcg-seed-incr 0
ros2 run benchbot_xarm6_cpp benchbot_xarm6_cpp -- --light-temp 6500,0.3,1 --both --closest --bench-sample-gap 1 --arm_random_locations 0 --arm-sample-gap 11 --pred "0,0,5" --pcg-seed-incr 0
#ros2 run benchbot_xarm6_cpp benchbot_xarm6_cpp -- --light-temp 6500,0.3,1 --both --closest --bench-sample-gap 1 --arm_random_locations 0 --arm-sample-gap 11 --pcg-seed-incr 0

#ros2 run benchbot_xarm6_cpp benchbot_xarm6_cpp -- --light-temp 6500,0.3,1 --both --closest --bench-sample-gap 1 --arm_random_locations 0 --arm-sample-gap 11 --pred "0,0,10" --pcg-seed-incr 1
#ros2 run benchbot_xarm6_cpp benchbot_xarm6_cpp -- --light-temp 6500,0.3,1 --both --closest --bench-sample-gap 1 --arm_random_locations 0 --arm-sample-gap 4 --pcg-seed-incr 0
